...
def signup():
    ...
    if request.method == "POST":
        ...
        try: # Check if entered email is already in use
            ...
            return render_template("signup.html", emailError=True) # Returns signup.html page with error message
            ...
            try: # Check if entered phone number is already in use
                ...
                return render_template("signup.html", phoneError=True) # Returns signup.html page with error message
            except auth.UserNotFoundError:
